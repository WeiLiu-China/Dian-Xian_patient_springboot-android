...
import com.glc.itbook.service.Utils;
...
public class XiangQingActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		shuming.setText("癫痫病人名字：" + name);
		zuozhe.setText("状态：" + author);
		jianjie.setText("病人电话：" + jianjieStr);
		//liulanqi.setText("定位：" + down);
	...
	protected void onStart() {
		...
		System.out.println("application1.getClassLoader().getClass()" + application1.getClass().getPackage().getName());
		System.out.println("application1.getClassLoader().getClass()" + application1.getClass().getSimpleName());
		System.out.println("application1.getClassLoader().getClass()" + application1.getClass().getName());
		LocationApplication application = (LocationApplication) application1;
