...
public class UpdateItemActivity extends AppCompatActivity {
    ...
    private void updateInfo(int id, String book_name, String shutu, String author, String info, String lianjie) {
        ...
        String url = "https://www.hautlw.xin/itbook-1.0/item/updateItem?id=" + id + "&book_name=" + book_name + "&book_img=" + shutu + "&book_author=" + author + "&book_info=" + info + "&book_download=" + lianjie + "";
